...
import 'package:splitzon/providers/settlement_provider.dart'; // ← NEW
import 'package:splitzon/features/commentActivity/activity_controller.dart';
import 'services/firebase_options.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        // SettlementProvider depends on ExpenseProvider
        ChangeNotifierProvider(
          create: (ctx) =>
              SettlementProvider(expenseProvider: ctx.read<ExpenseProvider>()),
        ),
